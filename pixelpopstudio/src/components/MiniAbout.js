...
const MiniAbout = () => {
  return (
    <section className="py-12 bg-gradient-to-b from-light-footer to-light-menuText dark:from-dark-background dark:to-dark-footer flex flex-col lg:flex-row items-center justify-center lg:px-16">
